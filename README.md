...
![easy-OTP service-time map](docs/img/result_map.jpg)
...
Download `easy_otp-0.2.0.zip` from the Assets section. This is the correctly
...
1. Download `easy_otp-0.2.0.zip` from the [Releases page](https://github.com/GISBoost/easy-OTP/releases/latest).
2. In QGIS: **Plugins → Manage and Install Plugins → Install from ZIP**.
3. Select the downloaded `easy_otp-0.2.0.zip` and click **Install Plugin**.
